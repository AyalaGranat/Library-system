...
public class Review implements Serializable {
    ...
    private String pathtoStringpic;
     ...
     */
    public Review(String readerFirstName, String readerLastName, String bookName, String reviewSentence, int rate,String pathtoStringpic) {
    	...
    	this.rate = rate;
    	this.pathtoStringpic=pathtoStringpic;
    }
    ...
    public String getPathtoStringpic() {
		return pathtoStringpic;
	}

	public void setPathtoStringpic(String pathtoStringpic) {
		this.pathtoStringpic = pathtoStringpic;
	}
